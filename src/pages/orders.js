            ...
            <div className="container-xxl py-5">
                <div className="container px-lg-5">
                    <div className="section-title position-relative text-center mb-5 pb-2 wow fadeInUp"
                        data-wow-delay="0.1s">
                        <h6 className="position-relative d-inline text-primary ps-4" title="coden our services">Our Products
                        </h6>
                    </div>
                    <a className="" title="whatsapp us to Order !"
                        ...
                        <div className="row g-4 justify-content-center">
                            <div className="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                                <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                                    ...
                                    <h5 className="mb-3">Review Card</h5>
                                    <p>Effortlessly gather reviews with our NFC Business Review Card. Customers tap and
                                        leave feedback, boosting your online presence instantly. Customizable and easy
                                        to
                                        use. Elevate your business today!
                                    </p>
                ...
                <p>Get Your card now <p> <a href="tel:+91 8277611667" className="fa fa-phone-alt me-3 text-blue">
                                +91 8277611667</a></p></p>
                </div>
        </section>
            ...
            <div className="container py-5 px-lg-5">
                <div className="row g-5">
                    <div className="col-md-6 col-lg-5">
                        ...
                        <p className="fa fa-envelope me-3 text-white"> GSTIN: 29AGWPJ3637Q1ZA</p>
