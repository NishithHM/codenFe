...
const Contact = ({ activeTab, setActiveTab, scrollToSection }) => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contact Coden Technologies | Software & IT Services in Bangalore
        </title>
        <meta
          name="description"
          content="Contact Coden Technologies - Your Trusted Software Development Partner in Bangalore"
        />
      </Helmet>
                ...
                <div className="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                  <div className="title-section position-relative mb-4 pb-2 topPaddingMeduim">
                    <h6
                      ...
                      title="Contact Coden Technologies for services"
                    >
                      Contact Us
                    </h6>
                    <h2 className="mt-2">
                      Ready to elevate your project with expert solutions? Get
                      in touch today.
                    </h2>
                  </div>
                  <p className="mb-4">
                    Need help with your next big project or want to discuss our
                    web development, mobile app development, or custom software
                    services? We're here to assist you. Contact Coden
                    Technologies today for a free consultation, and let's take
                  ...
                  <div className="d-flex align-items-center mt-4">
                    ...
                    <a
                      ...
                      title="Connect with Coden Technologies on LinkedIn"
                    ...
                    <a
                      className="btn btn-outline-primary btn-square me-3"
                      title="Follow Coden Technologies on Instagram"
                    ...
                    <a
                      ...
                      title="Like Coden Technologies on Facebook"
