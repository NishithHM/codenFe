    ...
    return (
        <div className="container-xxl bg-white p-0">
                        ...
                        <div className="row g-5">
                            <div className="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="section-title position-relative mb-4 pb-2 topPaddingMeduim">
                                    <h6 className="position-relative text-primary ps-4" title="coden's about us ">Contact Us
                                    </h6>
                                    <h2 className="mt-2">Ready to take your project to the next level? Contact us today.
                                    </h2>
                                </div>
                                <p className="mb-4">We're always here to help. Whether you have a question about our services,
                                    want to discuss a potential project, or simply need some advice, don't hesitate to get
                                    in touch with us.
                                </p>
                                <div style={{marginTop:'10px'}}>
                                    <a href="tel:+91 8277611667"
                                        className="btn btn-outline-primary  px-sm-5 rounded-pill animated fadeIn">tap to
                                        call</a>
                                </div>
            ...
            <div className="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                <h6 className="position-relative d-inline text-primary ps-4" title="coden our services">Maps
                </h6>
            </div>
            <iframe
                ...
                className="mapsIframe" style={{border:0}} allowfullscreen="" loading="lazy"
