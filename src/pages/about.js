    ...
    return (
        <div className="container-xxl bg-white p-0">
            <div id="spinner"
                ...
                <div className="spinner-grow text-primary" style={{height:'3em', width:'3em'}} role="status">
                        ...
                        <div className="row g-5">
                            <div className="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="section-title position-relative mb-4 pb-2 topPaddingMeduim">
                                    ...
                                    <h2 className="mt-2">We help business of every size - from Entrepreneurs to Iconic brand
                                    </h2>
                                </div>
                                <p className="mb-4">CODEN delivers high-quality and secure applications
                                    that meet the needs of our clients. Our experienced developers follow industry best
                                    practices and use the latest tools and technologies to ensure that our applications are
                                    not only user-friendly, but also reliable and secure !. We conduct rigorous testing and
                                    quality assurance procedures to ensure that our applications meet the highest standards
                                    of performance and security. Trust us to deliver a top-quality solution that meets your
                            ...
                            <div className="col-lg-4">
                                <img className="img-fluid wow zoomIn topPaddingLarge" data-wow-delay="0.5s"
                                    src="img/AboutCoden.png" alt="coden about image" title="coden about us image" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="faq">
                ...
                <div className="container-xxl bg-secondary testimonial py-5 my-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="container py-5 px-lg-5">
                        <div className="section-title position-relative text-center mb-5 pb-2 wow fadeInUp"
                            data-wow-delay="0.1s">
                            <h6 className="position-relative d-inline text-primary ps-4" title="coden our services">FAQ
                            </h6>
                        ...
                        <div className="owl-carousel testimonial-carousel">
                            <div className="testimonial-item bg-transparent border rounded text-white p-4">
                                ...
                                <div> <small>Tell us what you want</small></div>
                                <div> <small>We tailor your needs and provide the design</small></div>
                                <div><small>Once you finalise, we develop your dream website...</small></div>
                            </div>
                            <div className="testimonial-item bg-transparent border rounded text-white p-4">
                                <div className="d-flex align-items-center">
                                    <div className="ps-3 ">
                                ...
                                <div> <small>Depends on your requirement ! </small></div>
                                <div> <small>It starts from as low as 8000 INR</small></div>
                                <div><small>We provide a detailed quote before we start working</small></div>
                            </div>
                            <div className="testimonial-item bg-transparent border rounded text-white p-4">
                                <div className="d-flex align-items-center">
                                    <div className="ps-3 ">
                                ...
                                <div> <small>Also depends on your requirement !</small></div>
                                <div> <small>We take time and quality as top priority</small></div>
                                <div><small>We also provide time-estimation with quotation</small></div>
                            </div>
                            <div className="testimonial-item bg-transparent border rounded text-white p-4">
                                <div className="d-flex align-items-center">
                                    <div className="ps-3 ">
                                ...
                                <div> <small>We use latest tech to ensure the best security </small></div>
                                <div> <small>Our team uses secure coding practices</small></div>
                                <div><small>We use strict data protection policies</small></div>
                            </div>
                        </div>
                    </div>
                </div>
